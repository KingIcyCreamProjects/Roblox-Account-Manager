...
namespace RBX_Alt_Manager.Classes
{
    public partial class MissingAssetControl : UserControl
    {
        ...
        private async void MissingAssetControl_Load(object sender, EventArgs e)
        {
            ...
            if (Asset == null) // every download attempt failed — bail before dereferencing null Asset/AssetName
            {
                AssetNameLabel.Text = $"Asset {AssetId} (failed to load)";
        ...
        {
            if (Asset == null || !Asset.ContainsKey("ProductId") || !Asset.ContainsKey("PriceInRobux") || !Asset.ContainsKey("Creator")) return;
