    ...
    public partial class SettingsForm : Form
    {
        ...
        private void MultiRobloxCB_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (!AccountManager.Instance.UpdateMultiRoblox())
                MessageBox.Show("Roblox is currently running, multi roblox will not work if roblox is open.", "KingsRAM", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
        ...
        private void EnableWSCB_CheckedChanged(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("KingsRAM must be restarted to enable this setting", "KingsRAM", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void AllowExternalConnectionsCB_CheckedChanged(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("KingsRAM must be restarted to enable this setting\n\nThis setting requires admin privileges", "KingsRAM", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
